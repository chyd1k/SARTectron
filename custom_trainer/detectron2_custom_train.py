...
def main():
    ...
    name_of_train_dataset = "coco_Planes_detection_Train"
    ...
    train_path_annotation = "C:/Users/savchenko.bs/Desktop/new_placement/detectron2/Dataset_10k/Train_Data.json"
    ...
    # test_path_annotation = "C:/Users/savchenko.bs/Desktop/new_placement/detectron2/Dataset_10k/test_dataset_tiff/Train_Data.json"

    list_of_dicts_train = load_coco_json(train_path_annotation, imgs_root, dataset_name=name_of_train_dataset)
    DatasetCatalog.register(name_of_train_dataset, lambda: load_coco_json(train_path_annotation, imgs_root, name_of_train_dataset))
    list_of_dicts_test = load_coco_json(test_path_annotation, imgs_root, dataset_name=name_of_test_dataset)
    DatasetCatalog.register(name_of_test_dataset, lambda: load_coco_json(test_path_annotation, imgs_root, name_of_test_dataset))

    # visualize_img(name_of_test_dataset, 5)
    # visualize_img(name_of_test_dataset, 6)


    # planes_metadata = MetadataCatalog.get(name_of_train_dataset)
    # print(planes_metadata)
    # print(MetadataCatalog.get(name_of_test_dataset))
    
    # custom_mapper(list_of_dicts_train)
    ######################

    # config params function
    weights_root = "C:/Users/savchenko.bs/Desktop/new_placement/detectron2/weights/res_learning_08_06"
    cfg = create_cfg(weights_root, name_of_train_dataset, name_of_test_dataset)
